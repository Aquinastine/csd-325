...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.title("Luttrell To-Do App v2")
        ...
        msg = "--- Add Items Here --- **Right Click Item to Delete**"

        todo1 = tk.Label(self.tasks_frame, text=msg,bg="purple",
            fg="white", pady=10)
        ...
        self.colour_schemes = [ {"bg": "purple", "fg": "white"},
                               {"bg": "yellow", "fg": "black"}]
